...
- `DocumentClassifier`
Classifies documents into one of four types (invoice, contract, earnings_report, unknown).
...
### 🧠 LLM Strategy
- **Model:** GPT-4o from Azure OpenAI with support for structured outputs.
